...
static const yytype_uint8 yyprhs[] =
{
      ...
      22,    25,    29,    35,    41,    42,    51,    53,    55,    57,
      59,    61,    63,    65,    73,    75,    76
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      19,     0,    -1,    20,    -1,    21,    -1,    22,    -1,    23,
      -1,    27,    -1,    20,    21,    -1,    20,    22,    -1,    20,
      23,    -1,    20,    27,    -1,    20,     1,    12,    -1,     3,
      13,    17,    14,    12,    -1,     4,    13,    17,    14,    12,
      -1,    -1,    25,    16,    26,    13,    24,    28,    14,    12,
      -1,    17,    -1,     6,    -1,     8,    -1,     7,    -1,     9,
      -1,    10,    -1,    11,    -1,    25,    16,     5,    13,    17,
      14,    12,    -1,    17,    -1,    -1,    17,    29,    15,    28,
      -1
};
...
static const char *const yytname[] =
{
  ...
  "output", "gatename", "ff_definition", "fanin_list", "@2", 0
};
#endif
...
#line 70 "readcircuit.y"
    {
                       no_pi++;
                       if(!NameTable.is_member((yyvsp[(3) - (5)].str))){
                               gptr=new GATE;
                               gptr->SetName((yyvsp[(3) - (5)].str));
                               gptr->SetFunction(G_PI);
                               NameTable.insert((yyvsp[(3) - (5)].str),gptr);
                               Circuit.AddGate(gptr);

                       }
                       else{
                               gptr=NameTable.get_value((yyvsp[(3) - (5)].str));
                               gptr->SetFunction(G_PI);
                       }
                  ;}
    break;
...
#line 87 "readcircuit.y"
    {
                       ...
                       if(!NameTable.is_member((yyvsp[(3) - (5)].str))){
                               ...
                               NameTable.insert((yyvsp[(3) - (5)].str),inlist);
                               Circuit.AddGate(inlist);
                       }
                       else{
                               inlist=NameTable.get_value((yyvsp[(3) - (5)].str));
                               //inlist->SetFunction(G_PO);
                       }
...
#line 117 "readcircuit.y"
    {
                       no_gate++;
                       //for output
                       if(!NameTable.is_member((yyvsp[(1) - (4)].str))){
                               gptr=new GATE;
                               gptr->SetName((yyvsp[(1) - (4)].str));
                               NameTable.insert((yyvsp[(1) - (4)].str),gptr);
                               Circuit.AddGate(gptr);
                       }
                       else{
                               gptr=NameTable.get_value((yyvsp[(1) - (4)].str));
                       }
...
#line 145 "readcircuit.y"
    {
                       no_dff++;
                       //PPI
                       if(!NameTable.is_member((yyvsp[(1) - (7)].str))){
                               gptr=new GATE;
                               gptr->SetName((yyvsp[(1) - (7)].str));
                               gptr->SetFunction(G_PPI);
                               NameTable.insert((yyvsp[(1) - (7)].str),gptr);
                               Circuit.AddGate(gptr);
                       }
                       else{
                               gptr=NameTable.get_value((yyvsp[(1) - (7)].str));
                               gptr->SetFunction(G_PPI);
                       }
                       //Add inlist for PPI
                       name=(yyvsp[(5) - (7)].str);
                       ...
                       //PPO
                       name=string("PPO_")+(yyvsp[(5) - (7)].str);
                       if(!NameTable.is_member(name)){
                               gptr=new GATE;
                               gptr->SetName(name);
                               NameTable.insert(name,gptr);
...
#line 192 "readcircuit.y"
    {
                       if(!NameTable.is_member((yyvsp[(1) - (1)].str))){
                               inlist=new GATE;
                               inlist->SetName((yyvsp[(1) - (1)].str));
                               NameTable.insert((yyvsp[(1) - (1)].str),inlist);
                               Circuit.AddGate(inlist);
                               gptr->AddInput_list(inlist);
                       }
                       else{
                               inlist=NameTable.get_value((yyvsp[(1) - (1)].str));
                               gptr->AddInput_list(inlist);
                       }
          ;}
    break;
